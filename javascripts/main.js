...
define(function (require) {
    ...
    function repeat() {
        var repeatAnimation = animation().changePosition($rabbit1, rightRunningMap).repeatForever({delay:1000});
    ...
    function run() {
        ...
        }).repeat(6, {delay: 1000}).delay(6000).changePosition($rabbit3, rabbitWinMap).repeat(3, {delay: 2000}).delay(3000).changePosition($rabbit4, rabbitLoseMap).delay(3000).then(function () {
            console.log("finish");
        });
