...
define(function (require) {
    ...
    function run() {
        ...
        }).repeat(6, {delay: 1000}).wait(6000).changePosition($rabbit3, rabbitWinMap).repeat(3, {delay: 2000}).wait(3000).changePosition($rabbit4, rabbitLoseMap).wait(3000).then(function () {
            console.log("finish");
        });
